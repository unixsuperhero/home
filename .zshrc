...
alias glf="git log 1L DEC HEAD...\$(git merge-base --fork-point \$(git master))~"
alias glfp="git log 1L DEC HEAD...\$(git merge-base --fork-point \$(git master))~"
alias glfps="git log 1L DEC NS HEAD...\$(git merge-base --fork-point \$(git master))~"
...
alias gdf="git diff NON REL \$(git merge-base --fork-point \$(git master))"
alias gdfp="git diff NON REL \$(git merge-base --fork-point \$(git master))"
...
alias lspr="h pr ls -1o"
alias lspru="h pr ls -1ou"
alias prs="h pr ls -1o"
alias uprs="h pr ls -1ou"
